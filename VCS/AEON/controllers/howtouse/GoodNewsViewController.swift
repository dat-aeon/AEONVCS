...
//            self.newsControllerBarHeight.constant = 0
        ...
        func animateWithTransition(_ animator: AAViewAnimators) {
            tvNews.aa_animate(duration: 1.0, springDamping: .slight, animation: animator) { inAnimating, animView in
        ...
        override func viewWillAppear(_ animated: Bool) {
            ...
            tvNews.aa_animate(duration: 1.0, repeatCount: 1 ,springDamping: .slight, animation: .toLeft) { inAnimating, animView in
