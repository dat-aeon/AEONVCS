...
//  AEONVCS
//
//  Created by Khin Yadanar Thein on 2/8/19.
...
struct MemberData: Codable {
    var memberStatus, hotlinePhone, memberPhoneNo: String?
    var message, messageCode: String?
}

struct CheckMemberResponse1 : Codable {
    ...
    static func parseToCheckMemberResponse(_ data : JSON) -> CheckMemberResponse1 {
        let dictData = data.dictionary
        var checkMemberResponse = CheckMemberResponse1()
...
struct NewRegisterResponse: Codable {
    var status: String?
    var data: NewRegisterData?
}

struct NewRegisterData: Codable {
    var customerId: Int?
}
...
struct RegisterResponse: Codable {
    ...
    var delFlag:Int? = 0
    var password:String? = ""
    var appUsageDetailId:String? = ""
    var hotlinePhone:String? = ""
    var custAgreementListDtoList:[CustomerAgreementDtoList]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case delFlag
        case password
        case appUsageDetailId
        case hotlinePhone
        case custAgreementListDtoList
    }
    init(customerId:Int,customerNo:String,phoneNo:String,customerTypeId:String,userTypeId:String,name:String,dateOfBirth:String,nrcNo:String,photoPath:String, appUsageDetailId: String,hotlinePhone: String) {
        ...
        self.appUsageDetailId = appUsageDetailId
        self.hotlinePhone = hotlinePhone
    }
//
...
struct CustomerAgreementData:Codable{
    ...
    let qrShow, financialAmt, financialStatus: Int
    let agreementNo: String
    let importCustomerId, custAgreementId, financialTerm: Int
...
struct RegisterExistedRequestData : Codable {
    ...
    var appUsageInfo:AppUsageInfoReqBean?
     enum CodingKeys: String, CodingKey {
        ...
        case phoneNo
        case password
        case photoPath = "photoByte"
        case securityAnsweredInfoList = "customerSecurityQuestionDtoList"
        case appUsageInfo = "appUsageInfoDto"
        }
