...
//        self.lblTermsCon.text = engText
    ...
    func setDynamicPhNumber() {
        ...
        let phNo = sessionInfo?.hotlineNo?.replacingOccurrences(of: "+95", with: "0")
        ...
        AEON reserves the right to suspend the Online Service if repeatedly entered wrong Username, Password over the number of times allowed by AEON. In such case, transaction on process shall be immediately cancelled and the customer shall not be able to claim for any damages which may arise therefrom. To resume the Online Service, the customer can Call Center of AEON at \(phNo ?? "") during working days and hours.
    ...
    (၂) ဝန်ဆောင်မှုအသုံးပြုခြင်းဆိုင်ရာ သဘောတူညီမှု

    Online Services အား အသုံးပြုခြင်းဖြင့် Customerသည် အောက်ပါအချက်အလက်များအား သိရှိ နားလည် သဘောတူ လက်ခံပါသည်။
    ...
    ၃) မိုဘိုင်းအသုံးပြုခြင်းဆိုင်ရာ သတ်မှတ်ချက်များ
    Mobile Application အသုံးပြုရာတွင် လုံခြုံရေးအလို့ငှာ အောက်ပါအချက်များအား Customer မှ လိုက်နာဆောင်ရွက်ရန် သဘောတူညီပါသည်-
    ...
    ၇)ဝန်ဆောင်ခ
    အွန်လိုင်းဝန်ဆောင်မှုအား အသုံးပြုရာတွင် AEON မှ သတ်မှတ်ထားသော  ဝန်ဆောင်ခနှင့် အခြားသော ကုန်ကျစရိတ်များ ပေးဆောင်ရန် Customer မှ သဘောတူပါသည်။(လက်ရှိတွင် အွန်လိုင်း ဝန်ဆောင်ခ ပေးရန်မလိုပါ။)
