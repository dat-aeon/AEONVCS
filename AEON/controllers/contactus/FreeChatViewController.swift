...
//                                                if messageMenu == 8 {
//                                                    super.free_chat_socket_url.write(string: "ChangeReadFlagWithMsgId:\(((content[index] as AnyObject).value(forKey: "messageId") as? Int)!)")
//
//                                                    } else {
...
extension FreeChatViewController {
